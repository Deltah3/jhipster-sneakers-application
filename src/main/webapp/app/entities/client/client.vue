<template>
  <div>
    <h2 id="page-heading" data-cy="ClientHeading">
      <span v-text="t$('sneakersApplicationApp.client.home.title')" id="client-heading"></span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="t$('sneakersApplicationApp.client.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'ClientCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sneakersApplicationApp.client.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && clients && clients.length === 0">
      <span v-text="t$('sneakersApplicationApp.client.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="clients">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sneakersApplicationApp.client.nom')"></span></th>
            <th scope="row"><span v-text="t$('sneakersApplicationApp.client.adresse')"></span></th>
            <th scope="row"><span v-text="t$('sneakersApplicationApp.client.email')"></span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span
          id="sneakersApplicationApp.client.delete.question"
          data-cy="clientDeleteDialogHeading"
          v-text="t$('entity.delete.title')"
        ></span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-client-heading" v-text="t$('sneakersApplicationApp.client.delete.question', { id: removeId })"></p>
      </div>
