...
import fr.it_akademy.sneakers.repository.ClientRepository;
import fr.it_akademy.sneakers.service.dto.ClientDTO;
import fr.it_akademy.sneakers.service.mapper.ClientMapper;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).adresse(DEFAULT_ADRESSE).email(DEFAULT_EMAIL);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).adresse(UPDATED_ADRESSE).email(UPDATED_EMAIL);
