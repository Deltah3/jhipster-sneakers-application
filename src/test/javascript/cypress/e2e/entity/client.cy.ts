...
describe('Client e2e test', () => {
  ...
  const clientSample = { nom: 'clac aussitôt que', adresse: 'presque équipe de recherche', email: 'Paterne.Laurent80@hotmail.fr' };
  ...
  describe('new Client page', () => {
    ...
    it('should create an instance of Client', () => {
      cy.get(`[data-cy="nom"]`).type('éclater broum');
      cy.get(`[data-cy="nom"]`).should('have.value', 'éclater broum');

      cy.get(`[data-cy="adresse"]`).type('hi étant donné que du moment que');
      cy.get(`[data-cy="adresse"]`).should('have.value', 'hi étant donné que du moment que');

      cy.get(`[data-cy="email"]`).type('Christodule_Francois15@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Christodule_Francois15@gmail.com');
